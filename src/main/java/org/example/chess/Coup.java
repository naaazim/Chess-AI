...
public final class Coup {
    ...
    public Case depart() { return depart; }
    public Case arrivee() { return arrivee; }
    public Piece pieceDeplacee() { return pieceDeplacee; }

    public boolean estCapture() { return capture; }
    public Piece pieceCapturee() { return pieceCapturee; }

    public boolean estPromotion() { return promotion; }
    public Piece piecePromotion() { return piecePromotion; }

    public boolean estRoque() { return roque; }
    public boolean estEnPassant() { return enPassant; }
}
