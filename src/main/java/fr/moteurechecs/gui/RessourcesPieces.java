...
public class RessourcesPieces {
    ...
    private static void chargerImages() {
        ...
        // Ex: roi_blanc.svg, roi_noir.svg, etc.
        // Noms supposés basés sur le list_dir :
        // cavalier_blanc.svg, cavalier_noir.svg, fou_blanc.svg, etc.
    ...
    /**
     * Retourne le nœud JavaFX représentant une pièce à la taille demandée.
     *
     * @param piece     pièce à représenter (peut être {@code null} pour une case vide)
     * @param tailleCase taille en pixels du côté de la case
     * @return {@link Node} contenant l'image, ou {@code null} si la pièce est nulle
     */
